  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button title="Crea e scrivi su file" onPress={createAndWriteToFile} color="#ffffff" />
      </View>
      ...
      <View style={styles.buttonContainer}>
        <Button title="Sostituisci lettera" onPress={replaceLetter} color="#ffffff" />
      </View>
            {/* Bottone per leggere il contenuto del file */}
      <View style={styles.buttonContainer}>
        <Button title="Leggi file" onPress={readFromFile} color="#ffffff" />
      </View>
    </View>
  );
}
